...
function DetailBook() {
  ...
  const handleAdd=async (input)=>{
    ...
    .catch(err=>{
      ...
      console.log(err)
      warning(`${err.response.data.message[0]}`)
    })
  }
  ...
  const handleBuy=()=>{
    ...
    .then(async (res)=>{
      ...
      success("Đặt mua sách thành công");
      console.log(res)
            ...
            <div className="flex justify-between mt-3">
              ...
              <div>
                ...
                <Input
                  ...
                  type="number"
                  name="amount"
                  value={input.amount ? input.amount : null}
                  onChange={handleChange}
                />
                {/* <Input
          ...
          <div>
            {
              <div className="w-[50%] px-5 py-3">
                ...
                <Rate disabled defaultValue={2} className="text-[12px]" />
                <p className="text-[12px]">12/12/2002 10:11</p>
                <p>Sách Khá là yeu giang </p> */}
              ...
              {reviews.map((e, index)=>(
                  <div key={index}>
                    ...
                    <Rate disabled value={e.star} className="text-[12px]" />
